...
ThreadPoolTaskExecutor::ThreadPoolTaskExecutor(ThreadPoolMock* pool,
                                               NetworkInterface* net): _net1(net), _pool1(pool) {}
...
void ThreadPoolTaskExecutor::schedule1( std::function<void (Status)>  func) {

...
public:
   ...
   //  std::map<NodeID,CxtThreadProcSet> threadtoCxtthreadProc; 
...
private:
    ...
    {
       // threadtoCxtthreadProc[ctp.getTid()].insert(ctp);

        //  threadtoCxtthreadProc[] = &ctp;
